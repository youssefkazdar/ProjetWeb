...
function LoginPage() {
  ...
  const handleSubmit = (event) => {
    ...
    // Here you can implement your login logic, such as sending the username and password to your backend server for authentication
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            <form onSubmit={handleSubmit}>
              <div className="flex flex-row items-center justify-center lg:justify-start">
                ...
                {<img src="/instagram.png" alt="Facebook" width="30" height="30"></img>

                } <div>b </div>{ <img src="/facebook.png" alt="Facebook" width="30" height="30"></img>}
              </div>
